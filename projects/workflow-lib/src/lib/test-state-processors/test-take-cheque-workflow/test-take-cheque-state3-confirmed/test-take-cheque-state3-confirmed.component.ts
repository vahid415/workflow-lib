...
import { RequestCommitDto, TransitionEntity, RequestActionEntity } from '../../../common/types';
@Component({
  selector: 'lib-test-take-cheque-state3-confirmed',
  templateUrl: './test-take-cheque-state3-confirmed.component.html'
})

export class TestTakeChequeState3ConfirmedComponent {
  @Breadcrumb() breadcrumb: BreadcrumbItem = { textKey: 'State3-Confirmed' };
