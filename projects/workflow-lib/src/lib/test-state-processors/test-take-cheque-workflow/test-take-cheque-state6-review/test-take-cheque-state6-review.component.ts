...
@Component({
  selector: 'lib-test-take-cheque-state6-review',
  templateUrl: './test-take-cheque-state6-review.component.html'
})

export class TestTakeChequeState6ReviewComponent {
  @Breadcrumb() breadcrumb: BreadcrumbItem = { textKey: 'State6-Review' };
