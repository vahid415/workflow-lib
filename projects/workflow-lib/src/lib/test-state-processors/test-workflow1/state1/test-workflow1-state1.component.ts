...
import { UIService, Breadcrumb, BreadcrumbItem } from '@navaco/mcb-infra';

import { WorkflowService } from '../../../common/services/workflow-service';
import { RequestActionService } from '../../../common/services/request-action.service';
import { DtoBase, RequestCommitDto, RequestActionEntity, TransitionEntity } from '../../../common/types';

@Component({
  selector: 'mcb-workflow-test-workflow-state1',
  templateUrl: './test-workflow1-state1.component.html',
})
